...
{
    public class InsuranceRepository<T> : IInsuranceRepository<T> where T : class
    {

        private InsuranceEntities context;

        public InsuranceRepository(IInsuranceEntities context)
        {
            this.context = (InsuranceEntities)context;
        }
